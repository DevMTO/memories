...
export class MockTourRepository implements ITourRepository {
  private tours: Tour[] = [
...

    {
        ...
        itinerary: [
            ...
            description:
                'Salida temprano desde Cusco hacia Ollantaytambo, viaje en tren hasta el KM 104 donde inicia la caminata. Visita a Chachabamba, caminata hasta Wiñaywayna con box lunch y continuación hacia Intipunku para apreciar Machu Picchu. Descenso en bus hacia Aguas Calientes y noche en hotel.',
            ...
            includes: [
                ...
                'Guia especializado para el tour de Machu Picchu.',
  ...
  private packages: Package[] = [
        ...
        itinerary: [
    {
        ...
        description:
            "Recepción en el aeropuerto y traslado al hotel. Por la tarde visita al Qoricancha, Sacsayhuaman, Qenqo, Pucapucara y Tambomachay.",
        accommodations: "Hotel en Cusco",
        meals: [],
        includes: [
...

    {
        ...
        notIncludes: [
            ...
            'Propinas',
            'Costos adicionales o retrasos fuera del control de la agencia'
        ],
        ...
        slug: 'camino-inca-4-dias-3-noches',
        ...
        slug: 'inka-jungle-a-machu-picchu-4-dias-3-noches',
        ...
        slug: 'trekking-salkantay-laguna-humantay-machu-picchu-5-dias-4-noches',
        ...
        seoDescription:
            'Aventura de 5 días por Salkantay con Laguna Humantay, selva y visita final a Machu Picchu.',
